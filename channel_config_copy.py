...
def setUpChannel(channel: int = 0, openFlags=clb.Open.ACCEPT_VIRTUAL,bitrate=clb.Bitrate.BITRATE_1M, outputControl=clb.Driver.NORMAL):
    ...
    ch = clb.openChannel(channel, openFlags, bitrate)
